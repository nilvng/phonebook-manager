...
class CoreDataFriendStoreTests: XCTestCase {
    ...
    func addStubData(_ newFriend: Friend) {
        ...
        // Then
        let addedFriend : Friend? = sut.gets(id: newFriend.uid)
    ...
    func testUpdate() throws {
        ...
        // Then
        let updatedFriend : Friend? = sut.gets(id: friendToUpdate.uid)
    ...
    func testDelete() throws {
        ...
        // Then
        let deletedFriend : Friend? = sut.gets(id: friendToDelete.uid)
